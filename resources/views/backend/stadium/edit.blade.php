<x-backend>
	...
	<main class="app-content">
		<div class="app-title">
			<div>
				<h1> <i class="icofont-list"></i> Stadium Edit Form </h1>
			</div>
			<ul class="app-breadcrumb breadcrumb side">
				<a href="{{ route('backside.stadium.index') }}" class="btn btn-outline-primary">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="tile">
					<div class="tile-body">
						<form action="{{ route('backside.stadium.update',$id) }}" method="POST" enctype="multipart/form-data">
							@csrf 
							@method('PUT')
